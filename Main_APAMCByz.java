...
public class Main_APAMCByz {	
	...
	//array dei processi : [ [....], [....], [....], [....] ]
	// struttura per simulare scambio bit tra i processi: [ P0, P1, P2, P3 ] dove, per esempio P2 = [ bitRicevutoDaP0, bitRicevutoDaP1, bitInviatoDiP2,  bitRicevutoDaP3 ] 
	public static int[][] PROCs;

	//array che contiene la scelta che farà il processo i (i = 0, 1, 2, 3) al round successivo
	...
	public static void main(String[] args) {
		int[][] RES = new int[1024][2]; //RES = risultati di ogni run :=  [ [risultato accordo 0/1, quanti round] , ....]
		...
		for(var ar: RES) if(ar[0] == V ) count_rounds[ar[1]]++;
		
		int i = 0;
		for(var x : count_rounds) System.out.println("Numero round: " + (i++) + " --- Runs:"+  x );
		
		for(var ar:RES) if(ar[0] == V) histogram.addDataPoint(ar[1]);
